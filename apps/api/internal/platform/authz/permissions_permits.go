...
const (
	...
	PermApproveChildLeaveRequests = "approve_child_leave_requests"
)
...
func init() {
	Catalog = append(Catalog,
		...
		Permission{PermApproveChildLeaveRequests, "parent", "Approve or reject a linked child's leave request at a guardian workflow stage"},
	)
}
