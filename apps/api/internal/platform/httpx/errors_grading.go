...
var (
	...
	ErrGradebookInvalidScope  = NewError(http.StatusBadRequest, "GRADEBOOK_INVALID_SCOPE")
	ErrGradebookUnknownColumn = NewError(http.StatusBadRequest, "GRADEBOOK_REPORT_UNKNOWN_COLUMN")
)
