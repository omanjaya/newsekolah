...
// CirculationEventType is why one library_item_events row was written by
// the circulation half of the module: a borrow, return, renewal, or loss,
// as opposed to the catalogue half's own status-change audit trail (see
// domain.ItemEvent / domain.ItemEventType in item_event.go, which share
// the same table but a different write shape).
type CirculationEventType string

const (
	EventBorrowed  CirculationEventType = "borrowed"
	EventReturned  CirculationEventType = "returned"
	EventRenewed   CirculationEventType = "renewed"
	EventLost      CirculationEventType = "lost"
	EventDamaged   CirculationEventType = "damaged"
	EventReserved  CirculationEventType = "reserved"
	EventStocktake CirculationEventType = "stocktake"
)

// ItemEventRecord is one library_item_events row, written by circulation.
