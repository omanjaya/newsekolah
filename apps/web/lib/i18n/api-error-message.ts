...
const KNOWN_ERROR_CODES = new Set([
  ...
  "SCHEDULE_CONFLICT_CLASS",
  "SCHEDULE_CONFLICT_TEACHER",
  ...
  "LIBRARY_LOANS_CLOSED",
  "LIBRARY_UNPAID_FINE",
  "LIBRARY_FORBIDDEN",
  "LIBRARY_MEMBER_NOT_FOUND",
  "LIBRARY_MEMBER_ALREADY_EXISTS",
  "LIBRARY_MEMBER_NOT_ACTIVE",
  "LIBRARY_MEMBER_SUSPENDED",
  "LIBRARY_MEMBER_EXPIRED",
  "LIBRARY_MEMBER_NOT_CLEARABLE",
  "MODULE_DISABLED",
  ...
  "IMPORT_FILE_INVALID",
  "IMPORT_ROLE_UPDATE_FORBIDDEN",
  "SCAN_TOKEN_GONE",
  "SCAN_TOKEN_CONSUMER_NOT_STUDENT",
  "REASON_TOO_LONG",
  "LEAVE_CATEGORY_INVALID",
  "LEAVE_DATE_RANGE_INVALID",
  "LEAVE_REQUEST_GUARDIAN_NOT_LINKED",
