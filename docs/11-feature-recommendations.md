...
| 3 | **Portal dan aplikasi orang tua** | Orang tua tidak tahu anak alfa atau izin keluar | Role `parent` terhubung ke satu atau lebih siswa; melihat presensi, izin, SP, nilai (bila diizinkan), pengumuman; menyetujui izin terencana secara digital |
